    ...
    <html lang="en">
      <body className="min-h-screen font-sans">
        <header className="border-b border-ink-line/70 bg-ink/80 backdrop-blur sticky top-0 z-10">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 py-3 sm:py-5 flex items-center justify-between gap-3">
            <a
              href="/"
              className="font-mono text-xl sm:text-2xl tracking-tight text-white hover:text-accent-soft shrink-0"
            >
              <span className="text-accent">▣</span> lens
            </a>
            <nav className="flex items-center gap-4 sm:gap-8 text-base sm:text-lg text-zinc-300">
        ...
        <footer className="mx-auto max-w-5xl px-4 sm:px-6 py-10 sm:py-12 mt-8 sm:mt-12">
          <StatsBar />
