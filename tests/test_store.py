    ...
    papers = [
        {
            ...
            "abstract": f"Abstract {i}", "authors": ["Author"],
            "venue": None, "date": "2024-01-01", "arxiv_id": f"2401.{i:05d}",
            "citations": 0, "quality_score": 0.0, "extraction_status": "pending",
...
def test_store_vector_search(store):
    ...
    papers = [
        {
            "paper_id": "paper_a", "title": "About attention",
            "abstract": "Attention mechanisms", "authors": ["A"],
            "venue": None, "date": "2024-01-01", "arxiv_id": "paper_a",
            "citations": 0, "quality_score": 0.0, "extraction_status": "pending",
            "embedding": [1.0] + [0.0] * 767,
        },
        {
            "paper_id": "paper_b", "title": "About distillation",
            "abstract": "Knowledge distillation", "authors": ["B"],
            "venue": None, "date": "2024-01-01", "arxiv_id": "paper_b",
            "citations": 0, "quality_score": 0.0, "extraction_status": "pending",
